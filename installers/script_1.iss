...
#define MyAppName "Boost SysWeblurk V1.0.7"
#define MyAppVersion "1.0.7"
#define MyAppPublisher "Barba Tech"
#define MyAppURL "https://barbatech.solutions"
#define MyAppExeName "boost_sys_weblurk2.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{653A990C-7794-4F63-97C1-85124B0A1A5C}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Boost_SysWeblurk_V1.0.7
...
OutputBaseFilename=boost_sysweblurk
SetupIconFile=C:\Projects\BoostTwitch\boost_sys_weblurk\windows\runner\resources\app_icon.ico
...
Source: "C:\Projects\BoostTwitch\boost_sys_weblurk\build\windows\x64\runner\Release\flutter_inappwebview_windows_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Projects\BoostTwitch\boost_sys_weblurk\build\windows\x64\runner\Release\fullscreen_window_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Projects\BoostTwitch\boost_sys_weblurk\build\windows\x64\runner\Release\screen_retriever_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Projects\BoostTwitch\boost_sys_weblurk\build\windows\x64\runner\Release\webview_win_floating_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Projects\BoostTwitch\boost_sys_weblurk\build\windows\x64\runner\Release\boost_sys_weblurk2.exe.WebView2\*"; DestDir: "{app}\boost_sys_weblurk2.exe.WebView2"; Flags: ignoreversion recursesubdirs createallsubdirs
